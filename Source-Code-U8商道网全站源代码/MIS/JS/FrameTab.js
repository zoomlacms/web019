...
function InitNewFrameTab() {
    jQuery("#newFrameTab").click(function() {
        ...
        jQuery('<li id="iFrameTab' + (++lastFrameTabId) + '" ><a href="javascript:"><span id="frameTabTitle">新选项卡</span><a class="closeTab"><span class="glyphicon glyphicon-minus-sign"></span></a></a></li>')
