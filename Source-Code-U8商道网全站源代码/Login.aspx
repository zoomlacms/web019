<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite._Login, App_Web_x1zphvwk" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<style>
#login,#logged {padding-top:6px;}
#login li{ float:left; margin-right:10px; height:21px; line-height:21px;color:#333; font-size:14px;}
#logged li{font-size:14px;}
.C_input{ float:left;margin-left:3px;padding:0 5px 0 5px; background:#D91D12; border:none; color:#fff;}
.l_input{ width:70px;border:none; border:1px solid #ccc;}
#rnm{ float:right; display:block; width:50px; height:21px; line-height:21px; text-align:center; background:#D91D12; color:#fff;}
#logged li{margin-left:10px; line-height:21px; float:left;}
#PnlLoginMessage li{ float:left;}
#PnlLoginStatus li{ float:left;line-height:21px;}
...
<div id="login">
<ul>
<li>用户名：<asp:TextBox ID="TxtUserName" class="l_input" Width="97" runat="server"></asp:TextBox></li>
<li>密　码：<asp:TextBox ID="TxtPassword" class="l_input" runat="server" Width="97" TextMode="Password"></asp:TextBox></li>
...
<li style="display:"><asp:Literal ID="LitLoginTime" runat="server">0</asp:Literal></li> 
...
<div style="display:none"><iframe name="pasd" id="pasd" width="0px" height="0px"></iframe></div>
</asp:Panel>
