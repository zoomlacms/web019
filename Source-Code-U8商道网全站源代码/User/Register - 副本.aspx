            ...
            <li id="regVcodeRegister" runat="server" visible="false">
                <div class="reg_put">
                    <asp:TextBox ID="SendVcode" MaxLength="6" runat="server" Style="width: 60px; border: #CCC solid 1px;"
                        CssClass="input_out"  onmousemove="this.className='input_move'" onmouseout="this.className='input_out'" autocomplete="off" onkeyup="checkCode(this);" ClientIDMode="Static"></asp:TextBox>
                ...
                <div class="reg_put" style="width:96%">
                    ...
                    <table style="border-collapse: collapse" cellspacing="1" cellpadding="2" width="100%"
                        ...
                        <asp:CheckBox ID="CheckBox1" runat="server" Text=" 同意并接受注册协议" Visible="false" onclick="checkreg()" />
                                <input type="button" value="注册" onclick="code();" class="i_bottom"/>
                                <asp:Button ID="BtnSubmit" runat="server" Text=" 注册 " 
                                    CssClass="i_bottom" OnClick="BtnSubmit_Click" style="display:none;" ClientIDMode="Static"/> 
                                 <input id="Reset" type="reset" value=" 重置 " name="Reset" class="i_bottom" />
                                <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="true"
                                    ShowSummary="False" />
                                    如果你已有会员账户，请<a href="/user" style="color:#f00">点击这里</a>登录！
                            </td>
                        </tr>
                    </table>
