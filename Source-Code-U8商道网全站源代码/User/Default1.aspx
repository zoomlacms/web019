...
<a  href="/class_1/default.aspx" class="btn btn-info  pull-right" style=" margin-right:10px;" >创业项目</a>
   ...
   <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 paddingtop20">
 ...
 <button type="submit" class="btn btn-default">搜索</button>
     ...
     <div class="col-md-2 col-lg-2 col-sm-2 col-xs-12 pull-right paddingtop20" style="font-size:12px;">
    <a href="Message/Message.aspx" target="main_right"><%=lang.Get("u_info")%>(
...
<div class="u_tit"><strong><a href="/user/content/default.aspx" target="main_right">信息发布</a></strong></div>
  </div></div>
