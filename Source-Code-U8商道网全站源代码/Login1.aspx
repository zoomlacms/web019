<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite._Login, App_Web_rhk5prjt" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
#login li{ float:left; margin-right:8px; height:21px; line-height:21px;color:#333; font-size:14px;}
...
#logged li{margin-left:8px; line-height:21px; float:left;}
...
<div id="login">
<ul>
<li>用户名：<asp:TextBox ID="TxtUserName" class="l_input" Width="83" runat="server"></asp:TextBox></li>
<li>密　码：<asp:TextBox ID="TxtPassword" class="l_input" runat="server" Width="83" TextMode="Password"></asp:TextBox></li>
...
window.location = "/login1.aspx?Style=" +Style + "&page=<%= Server.HtmlEncode(Request["page"])%>";
});
}
//登录样式 1为纵向 2为横向
var Style = "<%=style%>";
